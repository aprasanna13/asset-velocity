...
interface PipelineNode {
    ...
    max: number;
    role: "Primary" | "Backup";
    status: "Active" | "Maintenance" | "Active (Boosted)";
}
        ...
        <div className="flex h-screen bg-slate-950 text-slate-200 font-sans selection:bg-blue-500/30" >
            ...
            < div className="w-64 border-r border-slate-800 bg-slate-900 flex flex-col p-4" >
                ...
                < nav className="flex-1" >
                    ...
                    < SidebarItem icon={RefreshCcw} label="Agentic Engine" active={activeTab === 'workflow'} onClick={() => setActiveTab('workflow')} />
                                ...
                                <div className="lg:col-span-2 space-y-6" >
                                    {!activeWorkflow ? (
                                        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-12 text-center flex flex-col items-center justify-center space-y-4" >
                                            ...
                                            < button onClick={() => { simulateAnomaly(); setActiveTab('dashboard'); }
                                            } className="text-blue-400 text-sm font-bold flex items-center gap-2" >
                            ...
                            <div className="animate-in zoom-in-95 duration-500" >
                                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8" >
                                    ...
                                    < div className="relative h-[400px] border border-slate-800 rounded-xl bg-slate-950 overflow-hidden flex items-center justify-center p-12" >
                                        <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: 'radial-gradient(#334155 1px, transparent 1px)', backgroundSize: '24px 24px' }
                                        }> </div>
